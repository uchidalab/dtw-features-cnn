...
def main(argv):
	...
	data_sets1 = input_data.read_data_sets(ns.TEST_FILE1, ns.TEST_FILE1, ns.IMAGE_SHAPE1, train_label=ns.TEST_LABEL1, test_label=ns.TEST_LABEL1, validation_ratio=0.0, pickle=False, boring=False)
	...
	data_sets2 = input_data.read_data_sets(ns.TEST_FILE2, ns.TEST_FILE2, ns.IMAGE_SHAPE2, train_label=ns.TEST_LABEL2, test_label=ns.TEST_LABEL2, validation_ratio=0.0, pickle=False, boring=False)

...
def random_selection(train_data, train_labels, proto_number, no_classes):
    # gets random prototypes
    return proto_data[proto_number], np.arange(proto_number)


def random_c_selection(train_labels, proto_number, no_classes):
...
def center_selection(proto_data, proto_loc, proto_number, train_data, train_labels):
    pass


def center_c_selection(proto_data, proto_loc, proto_number, train_data, train_labels, no_classes):
    pass


def border_selection(proto_data, proto_loc, proto_number, train_data, train_labels):
    pass


def border_c_selection(proto_data, proto_loc, proto_number, train_data, train_labels, no_classes):
    pass


def k_medians_selection(proto_data, proto_loc, proto_number, train_data, train_labels):
    pass


def k_medians_c_selection(proto_data, proto_loc, proto_number, train_data, train_labels, no_classes):
    pass
...
if __name__ == "__main__":
    ...
    proto_loc = random_c_selection(train_labels, proto_number, no_classes)

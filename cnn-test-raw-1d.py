...
def main(argv):
	...
	data_sets = input_data.read_data_sets(ns.TEST_FILE, ns.TEST_FILE, ns.IMAGE_SHAPE, train_label=ns.TEST_LABEL, test_label=ns.TEST_LABEL, validation_ratio=0.0, pickle=False, boring=False)
